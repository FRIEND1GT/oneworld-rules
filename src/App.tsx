...
import { Search, Shield, Menu, X, AlertTriangle, ChevronRight, Gavel, MessageSquare } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              {/* Desktop Tabs */}
              <div className="hidden lg:flex items-center gap-1 ml-8 bg-zinc-900/50 p-1 rounded-lg border border-zinc-800/50">
                <button
